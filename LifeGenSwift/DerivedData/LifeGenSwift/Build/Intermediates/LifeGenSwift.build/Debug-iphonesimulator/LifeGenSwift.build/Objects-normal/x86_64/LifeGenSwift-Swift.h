...
SWIFT_CLASS("_TtC12LifeGenSwift11AppDelegate")
...
SWIFT_CLASS("_TtC12LifeGenSwift9GameScene")
@interface GameScene : SKScene
@property (nonatomic, readonly) CGFloat pixelSize;
@property (nonatomic, readonly) double timeBetweenGenerations;
@property (nonatomic) double timeSinceLastGeneration;
...
SWIFT_CLASS("_TtC12LifeGenSwift18GameViewController")
...
SWIFT_CLASS("_TtC12LifeGenSwift7GoLCell")
@interface GoLCell : NSObject
@property (nonatomic) NSInteger numberOfNeighbors;
@property (nonatomic) BOOL isAlive;
@property (nonatomic, readonly) NSInteger gridRowMax;
@property (nonatomic, readonly) NSInteger gridColMax;
...
@interface SKNode (SWIFT_EXTENSION(LifeGenSwift))
